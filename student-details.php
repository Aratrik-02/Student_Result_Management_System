...
<table style="font-size: 20px; color: orange; margin-bottom:40px" align="center">
	...
	<form action="#" method="POST"">
		...
		<tr>
			...
			<td><input class="input-box" type="number" name="os" required></td>
		</tr>
		<tr>
			<td align="right"><h4>Object Oriented Programming :</h4></td>
			<td><input class="input-box" type="number" name="oops" required></td>
		</tr>
		<tr>
			<td align="right"><h4>Software Engineering :</h4></td>
			<td><input class="input-box" type="number" name="se" required></td>
		</tr>
		<tr>
			<td align="right"><h4>Artificial Intelligence :</h4></td>
			<td><input class="input-box" type="number" name="ai" required></td>
		</tr>
		<tr>
			<td align="right"><h4>Compiler Design :</h4></td>
			<td><input class="input-box" type="number" name="cd" required></td>
		</tr>
		<tr>
